                ...
                <form id="tags-form">
                    ...
                    <div class="multiselect">
                        <div class="selectBox" onclick="showCheckboxes()">
                            <select><option>Select the tags</option></select>
                            <div class="overSelect"></div>
                        </div>
                        <div id="checkboxes">
                            <label for="one"><input type="checkbox"/>Location</label>
                            <label for="two"><input type="checkbox"/>Time</label>
                            <label for="three"><input type="checkbox"/>Characters</label>
                            <label for="four"><input type="checkbox"/>Quests</label>
                        </div>
                    </div>
                    <input type="submit">
                </form>
